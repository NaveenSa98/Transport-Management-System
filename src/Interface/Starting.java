...
public class Starting {
	...
	private void initialize() {
		...
		frmZiptatransport.setIconImage(Toolkit.getDefaultToolkit().getImage("E:\\Acadamics\\Uni\\3 rd yr\\Java\\Transport Mangment System\\src\\coverimage.jpg"));
        ...
        try {
            img = ImageIO.read(new File("E:\\Acadamics\\Uni\\3 rd yr\\Java\\Transport Mangment System\\src\\coverimage.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        		...
        		try {
            		...
            		if(password.contains("admin.123")&& username.contains("admin")) {
            			...
            			textField_1.setText(null);
    						...
    						Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/Zipta", "root", "1234");
